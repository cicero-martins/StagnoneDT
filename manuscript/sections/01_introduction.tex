...
four-member ensemble (baseline with uniform roughness and no morphodynamics,
seagrass roughness only, waves only, and full physics) attributes the observed
improvements in Lagrangian skill to individual physical mechanisms.
