"""
Regrid v04r surface currents (Jul 8-9 re-run from restart at Jul 8 00:00,
mapInterval = 600 s) onto a rectilinear lat/lon grid for OpenDrift.

Identical structure to regrid_v04_for_opendrift.py, except:
  - reads from model/dflowfm_v04r/DFM_OUTPUT_*
  - time slice is Jul 8 00:00 -> Jul 10 00:00 (the v04r run window)
  - output: data/processed/v04r_surface_current.nc
...
Run:
    python scripts/regrid_v04r_for_opendrift.py
"""
...
V04R = ROOT / 'model' / 'dflowfm_v04r' / 'DFM_OUTPUT_Stagnone_dxy01_15m'
OUT = ROOT / 'data' / 'processed' / 'v04r_surface_current.nc'
...
# v04r ran Jul 8-9 only; start at the very beginning of the restart window
...
def main():
    ...
    print('\nAdding wind (u10, v10) from blended wind file (same as v04)...')
    wind_u_path = ROOT / 'model' / 'dflowfm_v04r' / 'wind_blended_u10n_20250701to20250710.nc'
    wind_v_path = ROOT / 'model' / 'dflowfm_v04r' / 'wind_blended_v10n_20250701to20250710.nc'
    ...
    ds_out = xr.Dataset(
        ...
        attrs={
            'Conventions': 'CF-1.8',
            'source': 'Regridded from Stagnone v04r (8 MPI partitions, mapInterval=600s) + blended wind',
